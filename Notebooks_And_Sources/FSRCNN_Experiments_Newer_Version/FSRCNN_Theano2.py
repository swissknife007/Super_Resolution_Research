...
def train_FSRCNN(train_set_x,train_set_y,valid_set_x,valid_set_y,test_set_x,test_set_y,
    ...
    f5 = 9
    input_image_size = 8
    output_len = (input_image_size- 1) * 2 + f5
    ...
    conv8 = Conv_Layer_ReLU(rng, conv7.output, image_shape=(batch_size,56,conv1_len,conv1_len),filter_shape = (3,56,f4,f4))
    
    conv9 = Deconv_Last.De_Conv_Layer_ReLU(rng, conv8.output, image_shape=(batch_size,3,output_len,output_len),filter_shape = (3,3,f5,f5))
    ...
    params = conv3.params + conv2.params + conv1.params + conv4.params + conv5.params + conv6.params + conv7.params + conv8.params + conv9.params
