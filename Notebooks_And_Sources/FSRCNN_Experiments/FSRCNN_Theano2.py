...
def train_FSRCNN(train_set_x,train_set_y,valid_set_x,valid_set_y,test_set_x,test_set_y,
    ...
    f5 = 10
    input_image_size = 8
    output_len = input_image_size + f5 -1
    ...
    conv5 = Conv_Layer_ReLU(rng, conv4.output, image_shape=(batch_size,12,conv1_len,conv1_len),filter_shape = (12,12,f3,f3))
    conv5_len = conv1_len
    
    
    conv6 = Conv_Layer_ReLU(rng, conv3.output, image_shape=(batch_size,12,conv1_len,conv1_len),filter_shape = (12,12,f3,f3))
    conv6_len = conv1_len
    
    conv7 = Conv_Layer_ReLU(rng, conv6.output, image_shape=(batch_size,12,conv1_len,conv1_len),filter_shape = (56,12,f4,f4))
    
    conv8 = De_Conv_Layer_ReLU2(rng, conv7.output, image_shape=(batch_size,56,conv1_len,conv1_len),filter_shape = (3,56,f5,f5))
    output_shape = (batch_size,3,16,16)
